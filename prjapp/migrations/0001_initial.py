# Generated by Django 4.2.1 on 2024-05-27 01:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('Amazon', 'Amazon'), ('Amazon-UK', 'Amazon-UK'), ('Amazon-German', 'Amazon-German'), ('Itunes', 'Itunes'), ('Razer-Gold', 'Razer-Gold'), ('Razer-Gold-Global', 'Razer-Gold-Global'), ('Master-Card', 'Master-Card'), ('Wolmart', 'Wolmart'), ('Nintendo', 'Nintendo'), ('Uber', 'Uber'), ('XBOX', 'XBOX'), ('FreeFire&Pubg', 'FreeFire&Pubg'), ('clothes', 'clothes'), ('other', 'other')], max_length=200)),
